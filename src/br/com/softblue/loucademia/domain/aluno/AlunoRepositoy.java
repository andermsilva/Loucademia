...
public class AlunoRepositoy {
	...
	public String getMaxMatriculaAluno() {
		
		return em.createQuery("SELECT MAX(a.matricula) "
				+ "FROM Aluno a WHERE a.matricula LIKE :ano",String.class)
